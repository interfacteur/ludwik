...
;var parametres = {
	...
	messages: {
		dropConfirmation: "FINE",
		dropErreur: "FALSE",
		generique: " does not dry in this environment.",

		aigle: "mostly breeds on cliffs and detects its prey from an elevated perch site.",
		alouette: "needs open habitats or a mosaic of different types of habitats, e.g. grass- and scrubland, pastures, etc.",
		bruant: "needs open habitats or a mosaic of different types of habitats, e.g. grass- and scrubland, pastures, etc.",
		circaete: "nests in trees (often pines), from there it goes to hunt reptiles in open areas (scrub- and grasslands, etc.).",
		engoulevent: ": his preferred habitat is dry, open country with some trees and small bushes.",
		faucon: ": his favoured breeding places are cavities in buildings (house roofs, ruins, stables, etc.) or nest boxes.",
		fauvette: "needs open habitats or a mosaic of different types of habitats, e.g. grass- and scrubland, pastures, etc.",
		gdduc: "nests on cliffs.",
		outarde: "male occupies the plains cultivated in short vegetation, to stay visible and parade. The female moves into the tall grass meadow, staying alone to conceal spawning.",
		pipit: "needs open habitats or a mosaic of different types of habitats, e.g. grass- and scrubland, pastures, etc.",
		ptduc: "nests in trees and buildings with cavities.",
		rollier: "settles in natural cavities or old woodpecker nests dug in the trees, such as White Poplar.",
		vautour: "nests on cliffs.",

		grimpeur: "It is important to develop recreational practices according to the nature's needs.\
			Climbing lanes must be created away from raptors nesting areas for example.",
		pylone: "The electrical pylonis causing risk of electrocution and collusion for large raptors.\
			Electric cables should either be buried or secured, in areas where those birds nest or hunt.",
		faucheuse: "The intensification of agriculture (widening of plots, hedges and wasteland disappearance, increased use of mechanical equipment,\
			fertilizers and pesticides) typically leads a strain on the species. For example, mechanical mowing can be dangerous for bustards settling\
			down and laying eggs on the meadows. Mowing periods are therefore regulated: they are thus prohibited during the nesting period from early\
			May to early August. Grazing turns out to be a good alternative.",
		maison: "It is tempting to want to settle in this beautiful landscape, however the construction of houses and roads gradually reduced the bird habitat.",
		benneEquarissage: "The systematic rendering of dead livestock by man generates the loss of food for scavengers, such as the Egyptian vulture.\
			Some exemptions are given to create \"feeding stations\" where corpses are available for \"natural renderers\" such as vultures.",
		futPesticides: "The pesticide use in agriculture must be limited because many birds lose their food resources due to the poisoning of their prey.",
		embroussaillement: "The proliferation of certain vegetation can be done sometimes at the expense of the birds. It is important to preserve the diversity\
			of the environments: scrublands, meadows, and forests... without one interfering with the other.",
		coupeArbreIsole: "Human intervention in the wild must take into account the ecological needs of different species.\
			A hollow shaft, a ruin, may be a refuge for many species like the little scops-owl.",

		threat1: "Identified threats: ",
		threat2: "\xA0/\xA0"
	},
