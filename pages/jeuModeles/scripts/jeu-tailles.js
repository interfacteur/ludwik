...
//Generic variables ----------------------------------------------------------------------------
	...
	instancie.init = function ii (cllbck) { //actualize variables (at loading, and 'play again' and 'play with other birds')
		...
		$hipster.css(commonLg.transition(delays[4]));
